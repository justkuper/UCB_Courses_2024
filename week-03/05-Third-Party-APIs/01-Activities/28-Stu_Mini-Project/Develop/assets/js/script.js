...
function createProjectCard(project) {
  ...
  cardBody.append(cardBody, cardDescription, cardDueDate, cardDeleteBtn);
  taskCard.append(taskCard, cardHeader, cardBody);
...
$(".swim-lanes").on('click', '.delete', handleDeleteProject);
